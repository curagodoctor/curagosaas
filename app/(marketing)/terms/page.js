...
export const metadata = {
  ...
  description:
    'The terms that govern your use of CuraGo — the website builder, booking, and the Dominate Organic Search programme.',
};
  ...
  return (
    <div className="legalRoot">
      ...
      <main className="legalWrap" style={{ padding: '48px 24px 96px' }}>
        ...
        <h2>1. Who we are</h2>
        <p>
          CuraGo provides a website builder, appointment booking, and the Dominate Organic Search programme for doctors
