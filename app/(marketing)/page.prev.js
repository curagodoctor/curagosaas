...
// The ₹499 ebook checkout link — set to your Razorpay Payment Page URL.
// Falls back to /signup so the button is never a dead 404.
const BOOK_URL = process.env.NEXT_PUBLIC_BOOK_URL || '/signup';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              Your patients are searching. They&apos;re finding someone else.
            </h1>
            <p className="text-lg md:text-xl text-[#64CB81] font-medium mb-8 max-w-3xl mx-auto">
              A doctor who knows medicine and nothing about being found online. We replace the vague instruction to &ldquo;build a digital presence&rdquo; with specific steps, in the right order — until patients find you first.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <Link
                href="/signup?entry=practice-os"
              ...
              >
                Get Practice OS — ₹5,000
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
              </Link>
              <Link href="/login?entry=website-builder" className="text-white/90 hover:text-white text-sm font-medium underline underline-offset-4">
                or build a free clinic site first
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* Two purchasable products — bundle (default) + book (alternative) */}
      <section className="relative -mt-10 md:-mt-14 pb-4 z-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Practice OS — the paid programme (default) */}
            <Link href="/signup?entry=practice-os" className="group bg-white rounded-2xl shadow-lg p-6 ring-2 ring-[#096b17] hover:shadow-xl transition-all hover:-translate-y-0.5 relative">
              <span className="absolute -top-3 left-6 text-[10px] font-bold text-white bg-[#096b17] px-2.5 py-1 rounded-full uppercase tracking-wide">The programme</span>
              <h3 className="text-xl font-bold text-gray-900 mt-2">Practice OS — 30-day programme</h3>
              <p className="text-sm text-gray-600 mt-1">One guided mission a day, done inside CuraGo. You finish with a real digital presence — not a certificate.</p>
              <div className="flex items-baseline gap-2 mt-4">
                <span className="text-2xl font-bold text-gray-900">₹5,000</span>
                <span className="text-sm text-gray-400">one-time · lifetime access to your work</span>
              </div>
              <span className="inline-flex items-center gap-1 text-[#096b17] font-semibold text-sm mt-4 group-hover:gap-2 transition-all">Get Practice OS →</span>
            </Link>

            {/* Book — alternative */}
            <a href={BOOK_URL} className="group bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all hover:-translate-y-0.5">
              <h3 className="text-xl font-bold text-gray-900">Zero to Practice — the ebook</h3>
              <p className="text-sm text-gray-600 mt-1">The foundational playbook. Start here if you want just the book.</p>
              <div className="flex items-baseline gap-2 mt-4">
                <span className="text-2xl font-bold text-gray-900">₹499</span>
              </div>
              <span className="inline-flex items-center gap-1 text-[#096b17] font-semibold text-sm mt-4 group-hover:gap-2 transition-all">Get the book →</span>
            </a>
          </div>
        </div>
      </section>

      {/* Practice OS — dark green surface + waitlist (launching ~2 months) */}
      <section className="py-14">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#053d0b] rounded-3xl p-8 md:p-10 text-center">
            <span className="inline-block text-[11px] font-bold text-[#64CB81] bg-white/10 px-3 py-1 rounded-full uppercase tracking-wide mb-4">Now open · Founding cohort</span>
            <h2 className="text-2xl md:text-3xl font-bold text-white">Practice OS — knowing isn&apos;t doing.</h2>
            <p className="text-emerald-100/90 max-w-2xl mx-auto mt-3">
              A 30-day guided programme that makes you build your digital presence — one specific mission a day, executed inside CuraGo, producing a real asset you own. The book teaches; Practice OS makes you do it.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-7">
              <Link href="/signup?entry=practice-os" className="inline-flex items-center justify-center gap-2 bg-white text-[#053d0b] px-7 py-3.5 rounded-xl font-semibold hover:bg-emerald-50 transition-colors">
                Get Practice OS — ₹5,000
              </Link>
              <Link href="/practice-os" className="inline-flex items-center justify-center gap-2 text-white/90 hover:text-white px-7 py-3.5 font-medium">
                See how it works →
              </Link>
            </div>
          </div>
