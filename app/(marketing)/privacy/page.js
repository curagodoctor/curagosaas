      ...
      <main className="legalWrap" style={{ padding: '48px 24px 96px' }}>
        ...
        <div className="card">
          <p style={{ margin: 0 }}>
            ...
            appointment booking, and the Dominate Organic Search programme for doctors in India. This policy covers
        ...
        <ul>
          ...
          <li><strong>Practice information</strong> — clinic name, specialty, qualifications, registration number, services, photos, and any content you add to your CuraGo website. If you upload a CV for Dominate Organic Search, we extract qualification and specialty details from it; the raw file and the extracted fields are stored separately, and you can delete either.</li>
        ...
        <ul>
          ...
          <li>Provide the Dominate Organic Search programme, including progress tracking and reminders you opt into.</li>
