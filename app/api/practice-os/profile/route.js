...
// PATCH /api/practice-os/profile — lightweight onboarding progress (current step
// + "already have a website?" branch). Kept separate from PUT so it never
// regenerates the AI summary; it's called on every wizard step change.
