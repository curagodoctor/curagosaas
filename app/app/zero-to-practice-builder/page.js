  ...
  return (
    <div className="w-full px-4 sm:px-8 lg:px-12 pt-[64px] pb-6 max-w-[1240px] mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        {[
          { label: 'Website enquiries', href: '/app/zero-to-practice-builder/leads', desc: 'Request-a-call-back form leads', accent: 'var(--orange)', soft: 'var(--orange-soft)', d: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
