...
const STEPS = [
  ...
  { key: 'profileBuilt', title: 'Build your profile with AI', desc: 'Answer a few prompts — the AI writes it up, you edit and approve.', href: '/app/control-center/profile/build', cta: 'Build profile' },
  ...
  { key: 'gbpConnected', title: 'Set up Google Business Profile', desc: 'The single biggest lever for being found locally.', href: '/app/control-center/gbp', cta: 'Set up GBP' },
];
        ...
        <div className="pos-card p-5 mt-6" style={{ borderColor: accessStatus === 'granted' ? 'var(--green)' : 'var(--orange)', background: accessStatus === 'granted' ? 'var(--green-soft)' : 'var(--orange-soft)' }}>
          {accessStatus === 'granted' ? (
            <>
              ...
              <button onClick={() => router.push('/app/control-center')} className="pos-action mt-3">Go to control center</button>
            </>
            ...
            <>
              ...
              <button onClick={() => router.push('/app/control-center/get-access')} className="pos-action mt-3">Get access</button>
            </>
          )}
        </div>
      )}
