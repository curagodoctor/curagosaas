...
export default function ProfilePage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (res.status === 402) { router.push('/app/control-center/unlock'); return; }
  ...
  return (
    <div className="max-w-xl mx-auto px-5 pt-[64px] pb-10">
      ...
      <a href="/app/control-center/profile/build" className="pos-card p-4 mb-8 flex items-center justify-between gap-3" style={{ borderLeft: '3px solid var(--orange)', textDecoration: 'none' }}>
        <div>
