    ...
    <div className="max-w-2xl mx-auto px-5 pt-[64px] pb-10">
      ...
      {status === 'pending' && (
        <div className="mt-8"><div className="pos-card p-6" style={{ borderColor: 'var(--orange)' }}>
          ...
          <button onClick={() => router.push('/app/control-center')} className="pos-link mt-4" style={{ fontSize: 14 }}>Go to control center →</button>
        </div></div>
      )}
      ...
      {submitted && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-5" style={{ background: 'rgba(16,26,19,.45)' }}>
          <div className="pos-card p-7 max-w-md w-full text-center" style={{ background: 'var(--card)' }}>
            ...
            <button onClick={() => router.push('/app/control-center')} className="pos-action mt-5 w-full">Go to my control center</button>
          </div>
        </div>
      )}
    ...
    <div className="mt-8">
      <div className="pos-card p-6" style={{ borderColor: 'var(--green)', background: 'var(--green-soft)' }}>
        ...
        <div className="flex flex-wrap items-center gap-3 mt-4">
          <button onClick={() => router.push('/app/control-center/clusters')} className="pos-action">Review my diseases &amp; treatments →</button>
