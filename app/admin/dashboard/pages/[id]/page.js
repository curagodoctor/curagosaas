...
import ThemeSelector from "@/components/admin/booking-pages/ThemeSelector";

// Section type definitions with metadata and SVG icons
// navName: Short name for navigation link
// navGroup: null = top-level, string = dropdown group name, "hidden" = exclude from nav
const SECTION_TYPES = [
  {
    type: "header",
    name: "Header / Navigation",
    navName: null,
    navGroup: "hidden", // Header itself is not in nav
    icon: (
  ...
  },
  {
    ...
    navName: "Services",
    navGroup: "Services", // Group: Services
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
