...
const PROFILE_KEYS = [
  'doctor_name', 'designation', 'specialty', 'subspecialty', 'qualifications',
  'additional_qualifications', 'years_experience', 'expertise', 'diseases', 'procedures',
  'usp', 'interests', 'languages', 'awards', 'publications', 'registration', 'age', 'gender',
];
...
- doctor_name (full name, e.g. "Dr. Yuvaraj T")
- designation (current role, e.g. "Consultant Surgical Gastroenterologist")
- specialty (primary medical specialty)
- subspecialty (subspecialties, comma-separated)
- qualifications (primary degrees, comma-separated, e.g. "MBBS, MS General Surgery, MCh Surgical Gastroenterology")
- additional_qualifications (fellowships / extra certifications, comma-separated)
- years_experience (digits only, or "")
- expertise (procedures/conditions they are especially known for, comma-separated)
- diseases (common conditions they treat, comma-separated)
- procedures (procedures they perform, comma-separated)
- usp (unique strength / differentiator, one plain sentence, no exaggeration)
- interests (professional/academic areas of interest, comma-separated)
- languages (languages they speak, comma-separated)
- awards (awards/honours, comma-separated)
- publications (notable publications, comma-separated, or a count)
- registration (medical council registration number)
- age (in years, digits only, or "")
- gender ("Male" | "Female" | "")
