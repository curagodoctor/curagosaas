...
const BLOCK_META = {
  suspension: { label: 'Suspension risk', mandatory: true, title: 'Learn account suspension and liability risks', desc: 'Mandatory before you touch a single field — what gets a profile suspended, re-verified, or removed, and what you are liable for as the listing owner.', aiPrompt: '' },
  competitor: { label: 'Competitor analysis', mandatory: false, title: 'Competitor analysis', desc: 'Research what real competing practices in your city and specialty are doing before you make subcategory choices — evidence, not guesswork.', aiPrompt: 'Based on this doctor\'s specialty and city, give a concise competitor-analysis briefing for their Google Business Profile: the primary GBP category likely used by strong competing practices in this specialty + city, 3-5 relevant secondary categories to consider, and 3-4 GBP attributes/services worth adding. Ground it in the doctor\'s profile; keep it practical and specific, not generic. NMC-compliant — no comparative or superlative claims.' },
  setup: { label: 'Profile setup', mandatory: false, title: 'Profile setup', desc: 'One-time setup, done from the clinic email — never a personal one. The high-risk, locked fields live here.', aiPrompt: '' },
  completion: { label: 'Profile completion', mandatory: false, title: 'Profile completion', desc: 'The editable layer — description, subcategories, attributes and timings. This is where the free foundation ends.', aiPrompt: 'Write a Google Business Profile "from the business" description for this doctor (max 750 characters), plus 5-8 suggested GBP subcategories and 5-8 relevant attributes, grounded in their specialty, procedures and city. Plain, patient-friendly, NMC-compliant — no superlatives, no guarantees, no soliciting.' },
};
