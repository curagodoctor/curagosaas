...
function buildSystemPrompt(authoredPrompt, mission, profileContext, profileFields = {}, module = null) {
  const context = [
...
export async function runMissionAssistant({ mission, module = null, userPrompt, profileContext, profileFields = {}, history = [] }) {
  ...
  try {
    ...
    const system = buildSystemPrompt(authoredPrompt, mission, profileContext, profileFields, module);
