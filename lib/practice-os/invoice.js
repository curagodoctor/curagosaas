    ...
    <div style="background:#fff;border:1px solid #DDE4D9;border-radius:14px;overflow:hidden">
      ...
      <div style="padding:26px">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:13.5px">
          ...
          <tbody>
            <tr><td style="padding:12px">${packTitle} — Zero To Practice Builder pack</td><td style="padding:12px;text-align:right">${inr(base)}</td></tr>
...
export async function sendInvoiceEmail(purchase) {
  ...
  const html = buildInvoiceHtml({ doctor, packTitle: framework?.title || 'Zero To Practice Builder', purchase });
