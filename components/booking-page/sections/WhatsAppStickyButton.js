...
export default function WhatsAppStickyButton({
  ...
  return (
    <a
      ...
      onClick={() => trackWhatsAppClick(`${trackingContext.pageSlug}_sticky_button`)}
      className={`fixed ${positionClasses} z-50 text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group`}
